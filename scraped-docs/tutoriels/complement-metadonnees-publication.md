source: https://geoplateforme.github.io/tutoriels/production/complement/metadonnees/publication/

[Diffusion](../../../tags/#tag:diffusion) [Métadonnée](../../../tags/#tag:métadonnée)
...
Il est maintenant possible de consulter la métadonnée sur le service CSW avec la requête [GetRecordById](https://data.geopf.fr/csw?REQUEST=GetRecordById&SERVICE=CSW&VERSION=2.0.2&ID=IGNF_RGEALTIr_2-0_ASC_5M_LAMB93_IGN69_D074.xml).
