source: https://geoplateforme.github.io/tutoriels/production/controle-des-acces/diffusion/permission/
...
Le champ `only_oauth` permet de forcer les consommateurs de données à exploiter la permission uniquement avec leur compte personnel, et non des clés moins sécurisées (voir le [tutoriel sur les clés](../cle/)).
