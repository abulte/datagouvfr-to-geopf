source: https://geoplateforme.github.io/tutoriels/production/raster/base/publication_wms/

[Diffusion](../../../tags/#tag:diffusion) [Donnée raster](../../../tags/#tag:donnée-raster) [WMS](../../../tags/#tag:wms)
...
On peut vérifier la présence de notre couche `scan1000` dans le [getCapabilities du service](https://data.geopf.fr/wms-r?REQUEST=GetCapabilities&SERVICE=WMS&VERSION=1.3.0)
