source: https://geoplateforme.github.io/sdk-entrepot/tutoriel_3_flux_raster/
...
Les données que la Géoplateforme va traiter sont situées dans le dossier `ain`. Le fichier `ain.md5` permettra de valider les données téléversées côté Géoplateforme.
