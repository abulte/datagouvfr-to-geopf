source: https://geoplateforme.github.io/sdk-entrepot/upload_descriptor/
...
Le fichier doit contenir une liste de `datasets`. Chaque _dataset_ représente une _livraison_ et doit contenir les informations suivantes :
...
Une fois le fichier descripteur de livraison créé, vous pouvez [envoyer les données](../comme-executable/#televerser-des-donnees) sur la Géoplateforme.
