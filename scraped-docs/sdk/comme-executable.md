source: https://geoplateforme.github.io/sdk-entrepot/comme-executable/
...
Pensez à [créer un fichier de configuration](../configuration/) indiquant au minimum vos identifiants.
...
Pour téléverser des données, vous devez générer un [fichier descripteur de livraison](../upload_descriptor/).
...
Pour réaliser des traitements et publier des données géographiques, vous devez générer un [fichier workflow](../workflow/).
...
Vous pouvez maintenant livrer et publier vos données en utilisant le module comme un exécutable. Voici quelques exemples :
  ...
  * [Tutoriel 1 : héberger une archive pour la rendre téléchargeable](../tutoriel_1_archive/)
  * [Tutoriel 2 : téléverser des données vecteur les publier en flux](../tutoriel_2_flux_vecteur/)
  * [Tutoriel 3 : téléverser des données raster les publier en flux](../tutoriel_3_flux_raster/)
